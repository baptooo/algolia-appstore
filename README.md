...
Here are the required tools to run this demo:

- [NodeJS LTS](https://nodejs.org/en/)
- [Yarn pkg](https://yarnpkg.com/lang/en/) (Not mandatory but the lockfile `yarn.lock` is generated by it)
...
It has the 3 following actions 
...
4. This is the component [SelectFacet](./src/components/facets/SelectFacet.js) that aims at letting the user filters the data using a select,
in this case it is used for the **category** facet
5. This is the component [RatingFacet](./src/components/facets/RatingFacet.js) that aims at filtering the results with a desired rating.
...
It takes benefit from the library [material-ui](https://www.material-ui.com/#/) to have strong and efficient components
...
A job is configured thanks to [Travis CI](https://travis-ci.org/baptooo/algolia-appstore) which will run for every modification and for two cases:
...
There are two kinds of tests in the application: **APIs** and **Components**
...
It uses [test renderer](https://reactjs.org/docs/test-renderer.html) to create snapshots of the components.
